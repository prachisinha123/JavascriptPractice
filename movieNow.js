...
const MoviesPage = () => {
  ...
  //   try {
  //     // Perform the search based on the entered searchText
  //     const searchUrl = `https://demo.onefin.in/api/v1/maya/movies/?search=${searchText}`;
  //     await fetchMovies(searchUrl);
  //   } catch (error) {
  //     console.error('Error searching movies:', error.message);
  //     setError('Failed to perform the search. Please try again.');
  //   }
  // };
  // ---------------------------------------------------------------
  ...
  // // 1st Code--------------code for 5)Search functionality
  // useEffect(() => {
  ...
  //   const subscription = debouncedInput.subscribe((event) => {
  ...
  return (
    ...
    <div key={movie.uuid} className="movie-card" onClick={() => handleCardClick(movie)} data-bs-toggle="modal" data-bs-target="#movieModal">    
      ...
      {/* <div key={movie.uuid} className="movie-card" onClick={() => handleCardClick(movie)}> */}
       ...
       Launch demo modal
         ...
         -primary" data-bs-toggle="modal" data-bs-target="#movieModal">
