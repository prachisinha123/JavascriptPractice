...
function handleSubmit(event){
   ...
   console.log(post);
   axios.post('https://demo.onefin.in/api/v1/usermodule/login/',{post})
        ...
        <div className="login">
          <div className="holder">
            ...
            <form onSubmit={handleSubmit}>
              ...
              { !emailValid && <p className="text-danger" onChange={handleInput}>Email is invalid/blank</p>}
              <input 
              ...
              { !passwordValid &&  <p className="text-danger"  onChange={handleInput}>Password is invalid/blank</p>}
            ...
            <br/>
            <br/>
           { isUserExist && <p className = "text-danger">User doesn't exist | Go for Signup</p>}
